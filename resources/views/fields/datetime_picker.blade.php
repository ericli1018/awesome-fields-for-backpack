...
@push('crud_fields_styles')
    ...
    <link href="{{ basset('https://cdn.jsdelivr.net/npm/pc-bootstrap4-datetimepicker@4.17.51/build/css/bootstrap-datetimepicker.min.css') }}" rel="stylesheet" type="text/css" />
    
@endpush

{{-- CUSTOM JS --}}
@push('crud_fields_scripts')
    <!-- include datetime_picker js-->
    ...
    @endif
    <script src="{{ basset('https://cdn.jsdelivr.net/npm/pc-bootstrap4-datetimepicker@4.17.51/build/js/bootstrap-datetimepicker.min.js') }}" crossorigin="anonymous"></script>
    @bassetBlock('backpack/crud/fields/datetime_picker.js')
    <script>
