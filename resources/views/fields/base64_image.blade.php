@php
    ...
    $field['filename'] = $field['filename'] ?? null;
...
@include('crud::fields.inc.wrapper_start')
    ...
    <div class="btn-group">
        ...
        @if(isset($field['crop']) && $field['crop'])
        <button class="btn btn-light " data-handle="rotateLeft" type="button" style="display: none;"><i class="la la-rotate-left"></i></button>
        <button class="btn btn-light " data-handle="rotateRight" type="button" style="display: none;"><i class="la la-rotate-right"></i></button>
        <button class="btn btn-light " data-handle="zoomIn" type="button" style="display: none;"><i class="la la-search-plus"></i></button>
        <button class="btn btn-light " data-handle="zoomOut" type="button" style="display: none;"><i class="la la-search-minus"></i></button>
        <button class="btn btn-light " data-handle="reset" type="button" style="display: none;"><i class="la la-times"></i></button>
        @endif
        <button class="btn btn-light " data-handle="remove" type="button"><i class="la la-trash"></i></button>
    </div>
...
@if ($crud->fieldTypeNotLoaded($field))
    ...
    @push('crud_fields_styles')
        <link href="{{ basset('https://cdnjs.cloudflare.com/ajax/libs/cropperjs/1.6.2/cropper.min.css') }}" rel="stylesheet" type="text/css" />
    ...
    @push('crud_fields_scripts')
        <script src="{{ basset('https://cdnjs.cloudflare.com/ajax/libs/cropperjs/1.6.2/cropper.min.js') }}" crossorigin="anonymous"></script>
        <script src="{{ basset('https://cdnjs.cloudflare.com/ajax/libs/jquery-cropper/1.0.1/jquery-cropper.min.js') }}" crossorigin="anonymous"></script>
        
        @bassetBlock('backpack/crud/fields/base64_image.js')
        <script>
